...
imports:
  ...
  - .agents/templates/do.template.md
  - .agents/templates/analysis.template.md
  - .agents/templates/report.template.md
  - .agents/templates/iteration-report.template.md
next-skill: null
pdca-phase: null
...
hooks:
  Stop:
    - type: command
      command: "node .bkit/plugin/scripts/pdca-skill-stop.js"
      timeout: 10000
---
...
## 004_AI_Project Domain Integration

This project uses PDCA for university research/admin automation tasks.
Domain-specific skills should be referenced during each PDCA phase:

### Phase-Skill Mapping

| PDCA Phase | Domain Skill | When to Trigger |
|------------|-------------|-----------------|
| Plan | `PaperResearch` | Feature involves academic research or literature review |
| Plan | `term-organizer` | New domain terminology discovered during planning |
| Design | `Mermaid_FlowChart` | Architecture or workflow visualization needed |
| Design | `PromptKit` | AI pipeline or prompt design involved |
| Do | `HWPX_Master` | Output includes Korean government document (.hwpx) |
...
When creating Plan documents for this project, always consider:
- **Output format**: hwpx (Korean gov), docx, pdf, or markdown
- **Data source**: RISS, KCI, internal university data
- **Encoding**: cp949 for HWP/CSV, UTF-8 for others
- **Naming**: `YYMMDD_[name]_[tag]` convention

### Auto-Trigger Integration

During PDCA Do phase, auto-suggest domain skills based on keywords:

| Keyword in Feature | Auto-Suggest |
|-------------------|--------------|
| "hwpx", "hwp", "Korean doc" | HWPX_Master |
| "paper", "research", "RISS" | PaperResearch |
| "Word", "docx", "PDF", "pptx" | DocKit |
| "diagram", "flowchart" | Mermaid_FlowChart |
| "prompt", "AI pipeline" | PromptKit |
| "file rename", "filename" | FileNameMaking |
