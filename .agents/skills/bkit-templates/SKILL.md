...
|----------|------|---------|
| Plan | `.agents/templates/plan.template.md` | Feature planning |
| Design | `.agents/templates/design.template.md` | Technical design |
| Analysis | `.agents/templates/analysis.template.md` | Gap analysis |
| Report | `.agents/templates/report.template.md` | Completion report |
| Index | `.agents/templates/_INDEX.template.md` | Document index |
| CLAUDE | `.agents/templates/CLAUDE.template.md` | CLAUDE.md template |
...
- `.agents/templates/pipeline/` directory
